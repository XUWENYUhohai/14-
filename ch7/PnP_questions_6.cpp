...
void bundleAdjustmentG2O(
    ...
    // add vertex1
    VertexPose *vertex_pose1 = new VertexPose(); // camera vertex_pose
    vertex_pose1->setId(1);
//    vertex_pose1->setFixed(1); // fix
    Eigen::Matrix3d R = Eigen::Matrix3d::Identity();
    Eigen::Vector3d t(0,0,0);
    vertex_pose1->setEstimate(Sophus::SE3d(R, t));
    ...
    // add edges connected to vertex1
