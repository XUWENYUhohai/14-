...
int main(int argc, char *argv[])
{
    ...
    bal_problem.WriteToPLYFile("./ch9/inital_g2o.ply");
    SolveBA(bal_problem);
    bal_problem.WriteToPLYFile("./ch9/final_g2o.ply");
    return 0;
}
...
/****************************************************************************/
        if(i < bal_problem.num_points() / 2) v->setMarginalized(true);
        else v->setMarginalized(false);
/****************************************************************************/
        optimizer.addVertex(v);
